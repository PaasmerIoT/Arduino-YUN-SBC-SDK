...
//===============================================================
#define AWS_IOT_MQTT_HOST "a3rwl3kghmkdtx.iot.us-west-2.amazonaws.com" 	// your endpoint
#define AWS_IOT_MQTT_PORT 8883									// your port
#define AWS_IOT_CLIENT_ID	DeviceName						// your client ID
#define AWS_IOT_MY_THING_NAME DeviceName						// your thing name
...
#define AWS_IOT_CERTIFICATE_PATH AWS_IOT_PATH_PREFIX DeviceName AWS_IOT_CERTIFICATE_FILENAME	// use this in config call
#define AWS_IOT_PRIVATE_KEY_PATH AWS_IOT_PATH_PREFIX DeviceName AWS_IOT_PRIVATE_KEY_FILENAME	// use this in config call
